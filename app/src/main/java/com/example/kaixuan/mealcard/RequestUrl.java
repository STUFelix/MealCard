...
public interface RequestUrl {
    ...
    Observable<Response<YKTBean>> getBalance(@Field("username") String username, @Field("password") String password);

    /**几天内的饭卡消费流水账单*/
    @FormUrlEncoded
    @POST("card/api/v2/detail")
    Observable<TheBean>  getDetail(@Header ("Cookie") String cookie, @Field("username") String username, @Field("password") String password, @Field("days") String days);
